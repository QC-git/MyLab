...
public:	\
	static T* CreateNew(U32 idCls=0) 	{ return new T; }	\
...
public:	\
	static I* CreateNew(U32 idCls=0) 	{ return new T; }	\
	void Release() 			{ delete this; }	\
	template< TYPENAME X >	static X* CreateNew(X**) { return static_cast<X>(new T); }	\
	template< TYPENAME X > X* QueryInterface(X**) { return static_cast<X*>(this); }	\
protected:
...
#define DELETE_DISABLED(T) \
	protected:\
		T (void) {}\
    virtual ~T() {}

#define DELETE_DISABLED_NOVIRTUAL(T) \
    protected:\
    T (void) {}\
    ~T() {}
...
typedef	uint32_t	I_ID;
typedef	uint32_t	CLS_ID;
...
#define DEFINE_THIS(T,V)	T* This() { return (T*)( ((U32)this) - OFFSET_OF(T,V) ); }

#define GUID_DECLAREEX(T, I, n) enum{I=n};
