...
// #ifdef RTSMAP_EXPORTS
// #define RTSMAP_API __declspec(dllexport)
// #else
// #define RTSMAP_API __declspec(dllimport)
// #endif
...
protected:
    IMaskData(){}
public:
    static RTSMAP_API IMaskData* LoadMaskData(const char* pszFileName);
    static RTSMAP_API IMaskData* LoadMaskData(float fMapMinX, float fMapMinY, float fMapMaxX, float fMapMaxY, float fCellSize, const SRtsNode *pNodes, size_t count);
    static RTSMAP_API IMaskData* CreateMapData(IMaskData* MapData);
    virtual ~IMaskData(){}
...
protected:
    IRtsMapTerminal(){}
public:
    static RTSMAP_API IRtsMapTerminal* CreateRtsMap(IMaskData* maskData,IMaskData* maskDataPlayer,IRtsMapCallBack* cb);
...
protected:
    IRtsMap(){}
public:
    static RTSMAP_API IRtsMap* CreateRtsMap(IMaskData* maskData,IMaskData* maskDataPlayer,IRtsMapCallBack* cb);
    virtual ~IRtsMap(){}
