...
#define INSTANTIATE_SINGLETON_1(TYPE) \
    template class MANGOS_DLL_DECL  Singleton<TYPE,  SingleThreaded<TYPE>,  OperatorNew<TYPE>,  ObjectLifeTime<TYPE> >; \
...
#define INSTANTIATE_SINGLETON_2(TYPE, THREADINGMODEL) \
    template class MANGOS_DLL_DECL  Singleton<TYPE, THREADINGMODEL,  OperatorNew<TYPE>,  ObjectLifeTime<TYPE> >; \
...
#define INSTANTIATE_SINGLETON_3(TYPE, THREADINGMODEL, CREATIONPOLICY ) \
    template class MANGOS_DLL_DECL  Singleton<TYPE, THREADINGMODEL, CREATIONPOLICY,  ObjectLifeTime<TYPE> >; \
...
#define INSTANTIATE_SINGLETON_4(TYPE, THREADINGMODEL, CREATIONPOLICY, OBJECTLIFETIME) \
    template class MANGOS_DLL_DECL  Singleton<TYPE, THREADINGMODEL, CREATIONPOLICY, OBJECTLIFETIME >; \
